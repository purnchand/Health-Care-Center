...
sym_des = pd.read_csv("C:\\Users\\user\\Desktop\\Health Care Centre App\\Health Care Centre\\datasets\\symtoms_df.csv")
precautions = pd.read_csv("C:\\Users\\user\\Desktop\\Health Care Centre App\\Health Care Centre\\datasets\\precautions_df.csv")
workout = pd.read_csv("C:\\Users\\user\\Desktop\\Health Care Centre App\\Health Care Centre\\datasets\\workout_df.csv")
description = pd.read_csv("C:\\Users\\user\\Desktop\\Health Care Centre App\\Health Care Centre\\datasets\\description.csv")
medications = pd.read_csv('C:\\Users\\user\\Desktop\\Health Care Centre App\\Health Care Centre\\datasets\\medications.csv')
diets = pd.read_csv("C:\\Users\\user\\Desktop\\Health Care Centre App\\Health Care Centre\\datasets\\diets.csv")

# load model
svc = pickle.load(open('C:\\Users\\user\\Desktop\\Health Care Centre App\\Health Care Centre\\models\\svc.pkl', 'rb'))
...
def home():
    if request.method == 'POST':
        ...
        if symptoms == "Symptoms":
            ...
            # Split the symptoms into a list and strip any surrounding whitespace
            user_symptoms = [s.strip() for s in symptoms.split(',')]

            # Remove any extra characters, if any
            user_symptoms = [symptom.strip("[]' ") for symptom in user_symptoms]

            # Assuming get_predicted_value is a defined function that predicts the disease
            predicted_disease = get_predicted_value(user_symptoms)

            # Assuming helper is a defined function that returns disease description, precautions, medications,
            # recommended diet, and workout
